...
<div class="section-content student-voices-details wf-section">
  ...
  <div class="container-900 w-container" data-ix="fade-in-from-bottom">
    <div class="student-voices-details-b">
      <div class="student-voices-details-img"><img src="{{ asset_frontend('images/student-voices-img-tina2x.jpg') }}" loading="lazy" sizes="(max-width: 479px) 54vw, (max-width: 767px) 36vw, (max-width: 991px) 39vw, (max-width: 1279px) 35vw, (max-width: 1439px) 26vw, 100vw" alt="" class="img"><img src="{{ asset_frontend('images/student-voices-slide-mask-mobile2x.png') }}" loading="lazy" alt="" class="student-voices-details-img-mask"></div>
