...
@section('content')
  <div class="section-inner-banner wf-section">
    <div class="inner-banner-img-b">
      @if($image = $about_message->getMedia('top_banner'))
        <div class="inner-banner-img codirectors-msg" data-ix="inner-banner-img" style="background-image:url('{{ $image->getResizedImage(2000) }}')"></div>
      @endif
    </div>
